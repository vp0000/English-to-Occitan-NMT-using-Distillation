...
3. Also, while finetuning obviously helps the teacher, the larger parameter count(7B for Mistral vs. 230M for Marian) indicates that there is more room to cover by improving the training setup, while ensuring better student performance through downstream distillation.
