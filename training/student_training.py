...
def save_model_config(trainer: Trainer, config: StudentTrainingConfig,dir_path: Optional[str]):
    """
...
def train_student_model(config: StudentTrainingConfig, tokenizer: AutoTokenizer, train_dataset: Dataset, eval_dataset: Dataset, dir_path: Optional[str] = None) -> Trainer:
    """
