...
class Config:
    ...
    base_dir: str = field(default_factory=lambda: os.getenv("NMT_BASE_DIR") or os.path.join(os.getcwd(), "project_data"))
    ...
    teacher_model: str = "mistralai/Mistral-7B-v0.3" # Mistral 7B base model
    student_model: str = "TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T"
    marian_model: str = "Helsinki-NLP/opus-mt-tc-big-en-cat_oci_spa"
    ...
    random_seed: int = 42
    cleaning_flag: bool = True  # Set to True if you have cleaning steps to perform before training, check using presence of cleaning.py files in utils
